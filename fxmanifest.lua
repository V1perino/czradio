...
author 'Hellslicer > CZ VERSION BY VipeR#5945'
...
supersede_radio 'RADIO_01_CLASS_ROCK' { url = 'https://icecast4.play.cz/country128.mp3', volume = 0.5, name = 'Country Radio' }
...
supersede_radio 'RADIO_07_DANCE_01' { url = 'https://25583.live.streamtheworld.com/BONTONAAC.aac', volume = 0.5, name = 'Bonton' }
...
supersede_radio 'RADIO_02_POP' { url = 'https://ice.actve.net/fm-evropa2-128', volume = 0.5, name = 'Evropa 2' }
supersede_radio 'RADIO_27_DLC_PRHEI4' { url = 'https://ice4.abradio.cz/dance128.mp3', volume = 0.5, name = 'Dance Club' }
supersede_radio 'RADIO_35_DLC_HEI4_MLR' { url = 'https://uk.radia.cz/uk128.aac', volume = 0.5, name = 'Rádio Ukrajina' }
